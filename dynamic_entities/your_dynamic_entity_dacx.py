...
"""dacx
1) A Workflow can be made dynamic by adding dynamic=True to the `@workflow.defn` decorator.
...
"""dacx
2) Similar to dynamic Workflows, an Activity can be made dynamic by adding `dynamic=True` to the `@activity.defn` decorator.
...
"""dacx
3) A Signal can be made dynamic by adding dynamic=True to the `@workflow.signal` decorator.
...
"""dacx
4) Similar to dynamic Signals, a Query can be made dynamic by adding `dynamic=True` to the `@workflow.query` decorator.
