...
from workflow_4_patch_complete import BackgroundCheck
...
async def main():
    ...
    async with Worker(
        ...
        print("Worker for 'patch complete' workflow started")
        await interrupt_event.wait()
        print("Shutting down 'patch complete' workflow worker")
